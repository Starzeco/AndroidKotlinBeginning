...
class CustomAdapter(val heightList: ArrayList<String>, val massList: ArrayList<String>, val bmiList: ArrayList<String>) : RecyclerView.Adapter<CustomAdapter.ViewHolder>() {
